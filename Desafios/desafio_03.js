...
*/
person.walk = function(valor) {
  this.metersToWalking += this.metersToWalking;
  this.walking = true;
}
...
person.fullName = function(name, lastName) {
  ...
  var fullNameIs = `Olá! Meu Nome é: ${name} ${lastName}`;// ES6
  return fullNameIs;
};
...
*/
person.showAge = function(age) {
  age = person.age;
  var showAge = `Olá, eu tenho ${age} anos!`;
  return showAge;
};
...
- "Eu peso [PESO]Kg."
*/
person.showWeight = function(weight) {
  weight = person.weight;
  var showWeight = `Eu peso ${weight} kg.`;
  return showWeight;
};
...
*/
person.showHeight = function(height) {
  height = person.height;
  var showHeight = `Minha altura é ${height}m`
  return showHeight;
};
/*
...
retornada)
*/
// console.log(person.makeBirthday() + 3)//42
